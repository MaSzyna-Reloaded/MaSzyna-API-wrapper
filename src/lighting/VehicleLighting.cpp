...
namespace godot {
    void VehicleLighting::_bind_methods() {
        ...
        ADD_PROPERTY(
                ...
                "", "get_power_source");
        ClassDB::bind_method(
                D_METHOD("get_front_headlight_upper_enabled"), &VehicleLighting::get_front_headlight_upper_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_front_headlight_left_enabled"), &VehicleLighting::get_front_headlight_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_front_headlight_right_enabled"), &VehicleLighting::get_front_headlight_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_front_redmarker_left_enabled"), &VehicleLighting::get_front_redmarker_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_front_redmarker_right_enabled"), &VehicleLighting::get_front_redmarker_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_rear_headlight_upper_enabled"), &VehicleLighting::get_rear_headlight_upper_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_rear_headlight_left_enabled"), &VehicleLighting::get_rear_headlight_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_rear_headlight_right_enabled"), &VehicleLighting::get_rear_headlight_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_rear_redmarker_left_enabled"), &VehicleLighting::get_rear_redmarker_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_rear_redmarker_right_enabled"), &VehicleLighting::get_rear_redmarker_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_active_headlight_upper_enabled"), &VehicleLighting::get_active_headlight_upper_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_active_headlight_left_enabled"), &VehicleLighting::get_active_headlight_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_active_headlight_right_enabled"), &VehicleLighting::get_active_headlight_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_active_redmarker_left_enabled"), &VehicleLighting::get_active_redmarker_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_active_redmarker_right_enabled"), &VehicleLighting::get_active_redmarker_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                ...
                &VehicleLighting::get_opposite_headlight_upper_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_opposite_headlight_left_enabled"), &VehicleLighting::get_opposite_headlight_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                ...
                &VehicleLighting::get_opposite_headlight_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                D_METHOD("get_opposite_redmarker_left_enabled"), &VehicleLighting::get_opposite_redmarker_left_enabled);
        ADD_PROPERTY(
                PropertyInfo(
        ...
        ClassDB::bind_method(
                ...
                &VehicleLighting::get_opposite_redmarker_right_enabled);
        ADD_PROPERTY(
                PropertyInfo(
