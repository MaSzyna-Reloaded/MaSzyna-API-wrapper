...
func _enable_plugin():
    ...
    add_autoload_singleton("MmdCabinInstancer", "res://addons/libmaszyna/mmd/mmd_cabin_instancer.gd")
    add_autoload_singleton("MmdManager", "res://addons/libmaszyna/mmd/mmd_manager.gd")
...
func _disable_plugin():
    ...
    remove_autoload_singleton("MmdManager")
    remove_autoload_singleton("MmdCabinInstancer")
