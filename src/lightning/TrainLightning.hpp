...
#include "resources/lightning/LightListItem.hpp"
#include <godot_cpp/classes/node.hpp>

namespace godot {
    class TrainController;
    class TrainLightning : public TrainPart {
        ...
        public:
             ...
             */
            TrainEngine::EngineType generator_engine = TrainEngine::EngineType::ENGINE_TYPE_MAIN;
