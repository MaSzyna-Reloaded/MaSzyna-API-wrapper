...
namespace godot {
    ...
    void Cabin3D::_bind_methods() {
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::BOOL, "cab_window_open"), "set_cab_window_open", "get_cab_window_open");
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::VECTOR3, "driver_position"), "set_driver_position", "get_driver_position");

        ADD_GROUP("Camera Shake", "");
        ClassDB::bind_method(
                D_METHOD("set_shake_spring_stiffness", "value"), &Cabin3D::set_shake_spring_stiffness);
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::FLOAT, "shake_jolt_limit"), "set_shake_jolt_limit", "get_shake_jolt_limit");
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::VECTOR2, "shake_angle_scale"), "set_shake_angle_scale",
                "get_shake_angle_scale");
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::FLOAT, "engine_shake_scale"), "set_engine_shake_scale",
                "get_engine_shake_scale");
        ClassDB::bind_method(
                D_METHOD("set_engine_shake_fade_in_rpm", "value"), &Cabin3D::set_engine_shake_fade_in_rpm);
        ...
        ClassDB::bind_method(
                D_METHOD("get_engine_shake_fade_out_factor"), &Cabin3D::get_engine_shake_fade_out_factor);
        ADD_PROPERTY(
    ...
    double Cabin3D::_engine_revolutions() const {
        ...
        const VehicleDieselEngine *engine = Object::cast_to<VehicleDieselEngine>(
                vehicle->get_component(VehicleComponentType::COMPONENT_ENGINE));
    ...
    void Cabin3D::_process_engine_shake(const double p_delta) {
        ...
        if (engine_revolutions > 0.0) {
            ...
            const double fade_out =
                    1.0 -
                    CLAMP((engine_revolutions - (engine_shake_fade_out_rpm / 60.0)) * engine_shake_fade_out_factor,
                          0.0, 1.0);
