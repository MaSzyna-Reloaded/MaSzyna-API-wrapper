...
namespace godot {
    ...
    E3DModelInstanceManager *E3DModelInstance::_get_manager() const {
        return Object::cast_to<E3DModelInstanceManager>(Engine::get_singleton()->get_singleton("E3DModelInstanceManager"));
    }
    ...
    void E3DModelInstance::_bind_methods() {
        ...
        BIND_PROPERTY(Variant::FLOAT, "vehicle_length", "vehicle_length", &E3DModelInstance::set_vehicle_length, &E3DModelInstance::get_vehicle_length, "vehicle_length");
