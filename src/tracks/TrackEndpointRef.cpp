...
namespace godot {
    void TrackEndpointRef::_bind_methods() {
        ...
        ClassDB::bind_method(
                D_METHOD("set_endpoint_index", "endpoint_index"), &TrackEndpointRef::set_endpoint_index);
        ClassDB::bind_method(D_METHOD("get_endpoint_index"), &TrackEndpointRef::get_endpoint_index);
        ADD_PROPERTY(
                PropertyInfo(Variant::INT, "endpoint_index"), "set_endpoint_index", "get_endpoint_index");
    }
    ...
    void TrackBranchNeighbors::_bind_methods() {
        ...
        ADD_PROPERTY(
                PropertyInfo(Variant::RID, "previous_track_rid"), "set_previous_track_rid",
                "get_previous_track_rid");
        ClassDB::bind_method(
        ...
        ClassDB::bind_method(
                D_METHOD("set_next_track_rid", "track_rid"), &TrackBranchNeighbors::set_next_track_rid);
        ...
        ClassDB::bind_method(
                D_METHOD("set_next_endpoint_index", "endpoint_index"),
                &TrackBranchNeighbors::set_next_endpoint_index);
