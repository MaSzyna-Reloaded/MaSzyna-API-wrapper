...
namespace godot {
    ...
    class TrainBuffer: public TrainPart {
        //@TODO: Improve constant and variable names
            GDCLASS(TrainBuffer, TrainPart);
        private:
...
VARIANT_ENUM_CAST(TrainBuffer::CouplerType)
VARIANT_ENUM_CAST(TrainBuffer::AllowedFlagBits)
VARIANT_ENUM_CAST(TrainBuffer::PowerFlagBits)
VARIANT_ENUM_CAST(TrainBuffer::BufferLocation)
