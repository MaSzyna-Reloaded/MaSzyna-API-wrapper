...
namespace godot {
    ...
    class CabinHUDMouseSystem : public Object {
        ...
        private:
            ...
            static bool _hit_part(const Part &p_part, const Vector3 &p_from, const Vector3 &p_to, double &r_distance,
                                  Vector3 &r_point);
            static bool _hit(const Pickable &p_pickable, const Vector3 &p_from, const Vector3 &p_to,
