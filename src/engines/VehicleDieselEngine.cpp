...
namespace godot {
    ...
    void VehicleDieselEngine::_bind_methods() {
        ...
        ClassDB::bind_method(
                D_METHOD("fuel_pump_switch_off", "enabled"), &VehicleDieselEngine::fuel_pump_switch_off);
