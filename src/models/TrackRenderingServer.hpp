...
namespace godot {
    ...
    class TrackRenderingServer : public Object {
        ...
        public:
            ...
            static TrackRenderingServer *get_instance() {
                return dynamic_cast<TrackRenderingServer *>(
                        Engine::get_singleton()->get_singleton("TrackRenderingServer"));
            }
            ...
            void update_track_data(
                    ...
                    float p_length);
            void update_rail_mesh(int64_t p_track_id, float p_length, float p_rail_spacing, float p_curve_precision);
