    ...
    class TrackManager : public Object {
        ...
        private:
            ...
            void _merge_endpoint_nodes(
                    const RID &p_first_track, int p_first_endpoint, const RID &p_second_track,
                    int p_second_endpoint);
        ...
        public:
            ...
            void track_update_properties(
                    const RID &p_track, int p_quality_flag, int p_environment, double p_sound_distance);
