...
namespace godot {
    void LightListItem::_bind_methods() { // Cabin A
        ...
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_a_end_signals, "cabin_a");
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_a_left_auxiliary_light, "cabin_a/left");
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_a_right_auxiliary_light, "cabin_a/right");
        // Cabin B
        ...
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_b_end_signals, "cabin_b");
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_b_left_auxiliary_light, "cabin_b/left");
        BIND_PROPERTY(LightListItem, Variant::BOOL, cabin_b_right_auxiliary_light, "cabin_b/right");
    }
} // namespace godot
