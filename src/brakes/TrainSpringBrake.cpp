...
namespace godot {
    void TrainSpringBrake::_bind_methods() {
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, spring_actuator_chamber_volume, "spring/actuator")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, spring_actuator_max_filling_force, "spring/actuator")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, pressure_force_coefficient)
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, spring_actuator_preload_pressure, "spring/actuator")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, spring_full_balance_pressure, "spring")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, brake_signal_released_state_pressure, "brake_signal")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, brake_signal_braked_state_pressure, "brake_signal")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, valve_cross_section_actuator_discharge, "valve_cross_section")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, valve_cross_section_actuator_charge, "valve_cross_section")
        BIND_PROPERTY(TrainSpringBrake, Variant::FLOAT, valve_cross_section_pneumatic_brake, "valve_cross_section")
        BIND_PROPERTY(TrainSpringBrake, Variant::INT, required_coupler_connection_method)

        ClassDB::bind_method(D_METHOD("set_spring_brake_active", "active"), &TrainSpringBrake::set_spring_brake_active);
        ClassDB::bind_method(
                D_METHOD("set_spring_brake_enabled", "enabled"), &TrainSpringBrake::set_spring_brake_enabled);
