...
namespace godot {
    void TrainElectricInductionEngine::_bind_methods() {
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, slip_current_ratio);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_slip);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, pole_pairs);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, nominal_uf_ratio);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, current_torque_ratio);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, current_three_phase_ratio);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_supply_voltage);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_supply_voltage_braking);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, inverter_voltage_drop);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, no_load_current);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, inverter_uf_setpoint);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, inverter_uf_setpoint_braking);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, initial_force);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, force_drop_rate);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_power);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_braking_force);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, max_braking_power);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, braking_decay_velocity);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, braking_decay_start_velocity);
        BIND_PROPERTY(TrainElectricInductionEngine, Variant::FLOAT, motor_max_current);
        BIND_PROPERTY_W_HINT_RES_ARRAY(
                TrainElectricInductionEngine, Variant::ARRAY, max_power_table, PROPERTY_HINT_TYPE_STRING,
                "CurvePointItem");
        BIND_PROPERTY_W_HINT_RES_ARRAY(
                TrainElectricInductionEngine, Variant::ARRAY, wwlist, PROPERTY_HINT_TYPE_STRING, "WWListItem");
    }
