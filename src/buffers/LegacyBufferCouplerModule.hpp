...
VARIANT_ENUM_CAST(godot::LegacyBufferCouplerModule::CouplerType)
VARIANT_ENUM_CAST(godot::LegacyBufferCouplerModule::AllowedFlagBits)
VARIANT_ENUM_CAST(godot::LegacyBufferCouplerModule::PowerFlagBits)
VARIANT_ENUM_CAST(godot::LegacyBufferCouplerModule::BufferLocation)
