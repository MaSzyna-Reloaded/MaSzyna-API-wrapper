...
namespace godot {
    ...
    void MoverVehicleLighting::_set_lights(TMoverParameters *p_mover) const {
        ...
        const int end_of_train = Maszyna::light::redmarker_left | Maszyna::light::redmarker_right | Maszyna::light::rearendsignals;
        ...
        while (vehicle != nullptr) {
            ...
            const bool head_free = lights_all_ends || vehicle->Couplers[head_end].Connected == nullptr ||
                                   !Maszyna::TestFlag(vehicle->Couplers[head_end].CouplingFlag, Maszyna::coupling::coupler);
            const bool tail_free = lights_all_ends || vehicle->Couplers[tail_end].Connected == nullptr ||
