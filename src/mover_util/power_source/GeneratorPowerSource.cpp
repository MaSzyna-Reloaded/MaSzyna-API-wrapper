...
namespace godot {
    void GeneratorPowerSource::_bind_methods() {
        BIND_PROPERTY_W_HINT(
                ...
                &GeneratorPowerSource::get_generator_type, "generator_type", PROPERTY_HINT_ENUM,
                "ElectricSeriesMotor,DieselEngine,SteamEngine,WheelsDriven,Dumb,DieselElectric,DumbDE,"
                "ElectricInductionMotor,Main,None")

        BIND_PROPERTY(
                Variant::FLOAT, "min_voltage", "voltage/min", &GeneratorPowerSource::set_generator_min_voltage,
                &GeneratorPowerSource::get_generator_min_voltage, "min_voltage")
        BIND_PROPERTY(
                Variant::FLOAT, "max_voltage", "voltage/max", &GeneratorPowerSource::set_generator_max_voltage,
                &GeneratorPowerSource::get_generator_max_voltage, "max_voltage")
        BIND_PROPERTY(
                Variant::FLOAT, "min_rpm", "rpm/min", &GeneratorPowerSource::set_generator_min_rpm,
                &GeneratorPowerSource::get_generator_min_rpm, "min_rpm")
        BIND_PROPERTY(
                Variant::FLOAT, "max_rpm", "rpm/max", &GeneratorPowerSource::set_generator_max_rpm,
                &GeneratorPowerSource::get_generator_max_rpm, "max_rpm")
