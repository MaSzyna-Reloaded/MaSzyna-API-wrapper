...
namespace godot {
    ...
    void LayeredSoundResource::_bind_methods() {
        ...
        ClassDB::bind_method(D_METHOD("set_starting_sounds"), &LayeredSoundResource::set_starting_sounds);
        ...
        ClassDB::bind_method(D_METHOD("set_main_sounds"), &LayeredSoundResource::set_main_sounds);
        ...
        ClassDB::bind_method(D_METHOD("set_ending_sounds"), &LayeredSoundResource::set_ending_sounds);
        ...
        ClassDB::bind_method(D_METHOD("set_amplitude_factor"), &LayeredSoundResource::set_amplitude_factor);
        ...
        ClassDB::bind_method(D_METHOD("set_amplitude_offset"), &LayeredSoundResource::set_amplitude_offset);
        ...
        ClassDB::bind_method(D_METHOD("set_frequency_factor"), &LayeredSoundResource::set_frequency_factor);
        ...
        ClassDB::bind_method(D_METHOD("set_frequency_offset"), &LayeredSoundResource::set_frequency_offset);
        ...
        ClassDB::bind_method(D_METHOD("set_sound_table"), &LayeredSoundResource::set_sound_table);
        ...
        ClassDB::bind_method(D_METHOD("set_pitch_table"), &LayeredSoundResource::set_pitch_table);
        ...
        ClassDB::bind_method(D_METHOD("set_pitch_variation"), &LayeredSoundResource::set_pitch_variation);
        ...
        ClassDB::bind_method(D_METHOD("set_cross_fade"), &LayeredSoundResource::set_cross_fade);
        ...
        ClassDB::bind_method(D_METHOD("get_sound_pitch"), &LayeredSoundResource::get_sound_pitch);
        ClassDB::bind_method(D_METHOD("get_sound_file_path"), &LayeredSoundResource::get_sound_file_path);
